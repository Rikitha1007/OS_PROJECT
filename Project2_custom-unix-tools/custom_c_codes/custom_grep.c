...
void display_file1(const char *filename, int number_lines, int number_non_blank, int show_ends, int suppress_blank, int show_tabs) {
...
int grep_main(int argc, char *argv[]) {
    ...
    for (int i = file_start; i < argc; i++) {
        display_file1(argv[i], number_lines, number_non_blank, show_ends, suppress_blank, show_tabs);
    }
